...
const DUMMY_MINISTRIES = [
  {
    ...
    description: "Empowering the next generation to lead with faith, hope, and love. Our youth programs focus on spiritual growth and community service.",
    detailed_description: "Our Youth Ministry is a vibrant community where teenagers can explore their faith, build lasting friendships, and serve others. We meet weekly for worship, bible study, and fun activities. We also organize annual retreats and local mission projects to help our youth put their faith into action.",
  ...
  {
    title: "Worship Team",
    description: "Leading our congregation in heart-felt worship through music and arts. Join us in creating an atmosphere of praise.",
    detailed_description: "The Worship Team is dedicated to glorifying God through excellent musical and technical ministry. Whether you play an instrument, sing, or are interested in sound and visuals, there's a place for you to serve. We focus on a blend of contemporary worship and timeless hymns.",
    image_url: "https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?q=80&w=2000&auto=format&fit=crop",
    schedule: "Practice on Thursdays at 6:30 PM",
    leader: "David Chen"
  },
  {
    title: "Children's Ministry",
    description: "Creating a safe and fun environment for children to learn about God's love. We have programs for all ages.",
    detailed_description: "Our Children's Ministry (Sunday School) provides age-appropriate lessons that bring the Bible to life. Through stories, crafts, and games, children discover the wonders of God's Word. We are committed to partnering with parents to build a strong spiritual foundation for every child.",
    image_url: "https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?q=80&w=2000&auto=format&fit=crop",
    schedule: "Sundays at 9:00 AM & 11:00 AM",
    leader: "Grace Miller"
  },
  {
    title: "Community Outreach",
    description: "Reaching out to our neighbors with the love of Christ through practical help and service projects.",
    detailed_description: "Community Outreach is the hands and feet of our church. We organize food drives, support local shelters, and host community events. Our goal is to make a tangible difference in the lives of those around us, sharing the hope we have in Jesus through our actions.",
    image_url: "https://images.unsplash.com/photo-1469571483350-8987713b35ee?q=80&w=2000&auto=format&fit=crop",
    schedule: "First Saturday of every month",
    leader: "Robert Peterson"
  }
];

    ...
    <div className="relative h-screen min-h-[600px] flex items-center justify-center bg-gray-900 overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto mt-16">
        ...
        <p className="text-gray-200 text-lg md:text-xl mb-10 max-w-2xl mx-auto animate-fade-in-up delay-200">
          We are a community reaching the world with the love of Christ. Join us this Sunday for a life-changing experience.
        </p>
        
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up delay-300">
          <button className="px-8 py-4 bg-primary text-white text-sm font-bold uppercase tracking-widest hover:bg-red-600 transition-colors flex items-center justify-center gap-2 group">
            <PlayCircle size={20} /> Watch Online
          </button>
          <button className="px-8 py-4 bg-transparent border-2 border-white text-white text-sm font-bold uppercase tracking-widest hover:bg-white hover:text-secondary transition-all flex items-center justify-center gap-2 group">
            I'm New Here <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
          </button>
        </div>
      </div>

                            ...
                            <div className="flex flex-col md:flex-row gap-8 items-start">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 leading-relaxed italic">
                                        "Zegen Church began as a small
                                        home-based prayer group in 1998. Five
                                        families came together, driven by a
                                        shared vision to create a community
                                        where the love of Christ could be
                                        experienced in its purest form."
                                    </p>
                                </div>
                            </div>
